// Page Layout Component for Wedding Invitations

window.weddingSectionComponents = window.weddingSectionComponents || {};

window.weddingSectionComponents.layout = {
    name: '🎨 Page Layout',
    allowMultiple: false,
    info: (sectionId) => `
        <div class="space-y-4">
            <div class="border-b pb-4 mb-4">
                ...
                <div class="space-y-2">
                    <label class="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                        <input type="radio" name="navType_${sectionId}" value="none" class="section-data" data-field="navType" onchange="toggleNavigationSettings(this); updatePreview()" checked>
                        <div>
                    ...
                    <label class="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                        <input type="radio" name="navType_${sectionId}" value="tabview" class="section-data" data-field="navType" onchange="toggleNavigationSettings(this); updatePreview()">
                        <div>
                    ...
                    <label class="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                        <input type="radio" name="navType_${sectionId}" value="topnav" class="section-data" data-field="navType" onchange="toggleNavigationSettings(this); updatePreview()">
                        <div>
                    ...
                    <label class="flex items-center gap-3 p-3 border rounded-lg cursor-pointer hover:bg-gray-50">
                        <input type="radio" name="navType_${sectionId}" value="bottomnav" class="section-data" data-field="navType" onchange="toggleNavigationSettings(this); updatePreview()">
                        <div>
            ...
            <div id="tabViewSettings" class="space-y-4 hidden">
                ...
                <div>
                    ...
                    <textarea placeholder="Invitation&#10;Our Story&#10;Gallery&#10;RSVP" rows="5" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 section-data" data-field="tabNames" oninput="updatePreview(); updateSectionNavigationDropdowns()"></textarea>
            ...
            <div id="topNavSettings" class="space-y-4 hidden">
                ...
                <div>
                    ...
                    <textarea placeholder="Home&#10;Details&#10;Story&#10;RSVP" rows="5" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 section-data" data-field="navItems" oninput="updatePreview(); updateSectionNavigationDropdowns()"></textarea>
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            <label class="flex items-center gap-2">
                                ...
                                <span class="text-sm font-medium text-gray-700">Sticky Navigation (stays at top while scrolling)</span>
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div id="bottomNavSettings" class="space-y-4 hidden">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Navigation Items (one per line)</label>
                    <textarea placeholder="Home&#10;Details&#10;Story&#10;RSVP" rows="5" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 section-data" data-field="bottomNavItems" oninput="updatePreview(); updateSectionNavigationDropdowns()"></textarea>
                    <p class="text-xs text-gray-500 mt-1">Define the navigation menu items</p>
                </div>
                <div class="border-t pt-4">
                    <h4 class="text-sm font-semibold text-gray-700 mb-3">Navigation Bar Style</h4>
                    <div class="space-y-3">
                        ...
                        <div>
                            <label class="flex items-center gap-2">
                                <input type="checkbox" class="section-data" data-field="bottomNavSticky" onchange="updatePreview()" checked>
                                <span class="text-sm font-medium text-gray-700">Sticky Navigation (stays at bottom while scrolling)</span>
                            </label>
                        </div>
                    </div>
                </div>
