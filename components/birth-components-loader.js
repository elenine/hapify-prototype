// Birth Announcement Component Loader
// This script loads all birth announcement section components and makes them available globally
...
// List of all available birth announcement components
const componentFiles = [
    'layout', 'hero', 'stats', 'parents', 'story', 'message',
