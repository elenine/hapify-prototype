    ...
    render: (data, style) => `
        <div class="py-12 px-6 text-center" style="background: ${style.bg || '#fdf2f8'}">
            <div class="max-w-md mx-auto">
                ...
                ${data.link ? `<a href="${data.link}" target="_blank" class="inline-block bg-rose-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-rose-700 transition">View Registry</a>` : ''}
            </div>
        </div>
    `
};
