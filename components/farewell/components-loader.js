// Component Loader for Farewell Party
...
console.log('🔄 Farewell Party component loader started');

// List of all available components
const componentFiles = [
    'layout', 'hero', 'aboutperson', 'farewell', 'memories',
    'partydetails', 'wellwishes', 'rsvp', 'gallery', 'contact'
];
