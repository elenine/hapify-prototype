    ...
    render: (data, style, globalStyles) => `
        <div class="py-12 px-6 text-center" style="background: ${style.bg || '#fff7ed'}">
            <div class="max-w-md mx-auto">
                ...
                <p class="text-gray-600 mb-6">${data.message || "Let us know if you can join us"}</p>
                ...
                <button class="bg-orange-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-orange-600 transition">
                    RSVP Now
                </button>
            </div>
        </div>
