// Page Layout Component for Graduation Ceremony
        ...
        <div class="space-y-4">
            ...
            <div id="tabViewSettings" class="space-y-4 hidden">
                ...
                <div>
                    ...
                    <textarea placeholder="About&#10;Ceremony&#10;Gallery&#10;Celebration" rows="5" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 section-data" data-field="tabNames" oninput="updatePreview(); updateSectionNavigationDropdowns()"></textarea>
                ...
                <div class="border-t pt-4">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 section-data" data-field="tabStyle" onchange="updatePreview()">
                        ...
                        <div>
                            ...
                            <select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 section-data" data-field="tabAlignment" onchange="updatePreview()">
                        ...
                        <div>
                            ...
                            <select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 section-data" data-field="tabSize" onchange="updatePreview()">
            ...
            <div id="topNavSettings" class="space-y-4 hidden">
                ...
                <div>
                    ...
                    <textarea placeholder="About&#10;Ceremony&#10;Gallery&#10;Celebration" rows="5" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 section-data" data-field="navItems" oninput="updatePreview(); updateSectionNavigationDropdowns()"></textarea>
                ...
                <div class="border-t pt-4">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 section-data" data-field="navStyle" onchange="updatePreview()">
                        ...
                        <div>
                            ...
                            <select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 section-data" data-field="navAlignment" onchange="updatePreview()">
                                <option value="left" selected>Left</option>
                                <option value="center">Center</option>
                                <option value="right">Right</option>
                            </select>
                        ...
                        <div>
                            ...
                            <select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 section-data" data-field="navSize" onchange="updatePreview()">
                                <option value="small">Small</option>
                                <option value="medium" selected>Medium</option>
                                <option value="large">Large</option>
                            </select>
            ...
            <div id="bottomNavSettings" class="space-y-4 hidden">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Navigation Items (one per line)</label>
                    <textarea placeholder="About&#10;Ceremony&#10;Gallery&#10;Celebration" rows="5" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 section-data" data-field="bottomNavItems" oninput="updatePreview(); updateSectionNavigationDropdowns()"></textarea>
                    <p class="text-xs text-gray-500 mt-1">Define the navigation menu items</p>
                </div>
                <div class="border-t pt-4">
                    <h4 class="text-sm font-semibold text-gray-700 mb-3">Navigation Bar Style</h4>
                    <div class="space-y-3">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Navigation Style</label>
                            <select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 section-data" data-field="bottomNavStyle" onchange="updatePreview()">
                                <option value="simple" selected>Simple</option>
                                <option value="underline">Underline Active</option>
                                <option value="pills">Pills</option>
                                <option value="bordered">Bordered</option>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Navigation Alignment</label>
                            <select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 section-data" data-field="bottomNavAlignment" onchange="updatePreview()">
                                <option value="left" selected>Left</option>
                                <option value="center">Center</option>
                                <option value="right">Right</option>
                            </select>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Navigation Size</label>
                            <select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 section-data" data-field="bottomNavSize" onchange="updatePreview()">
                                <option value="small">Small</option>
                                <option value="medium" selected>Medium</option>
                                <option value="large">Large</option>
                            </select>
            ...
            <div class="text-sm text-gray-600 pt-4 border-t">
                <p>This section controls the overall styling and appearance of your entire graduation page.</p>
    ...
    style: `
        <div class="space-y-4">
            <div>
                ...
                <input type="color" value="#6366f1" class="w-full h-12 rounded-lg cursor-pointer section-style" data-style="primaryColor" oninput="updatePreview()">
                <p class="text-xs text-gray-500 mt-1">Used for headings and accents</p>
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Secondary Color</label>
                <input type="color" value="#4f46e5" class="w-full h-12 rounded-lg cursor-pointer section-style" data-style="secondaryColor" oninput="updatePreview()">
            ...
            <div>
                ...
                <select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 section-style" data-style="fontFamily" onchange="updatePreview()">
