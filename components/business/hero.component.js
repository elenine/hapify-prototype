...
window.sectionComponents.hero = {
                ...
                style: `
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 section-style" data-style="bannerMode" onchange="updatePreview()">
                        ...
                        <div>
                            ...
                            <select class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 section-style" data-style="bannerHeight" onchange="updatePreview()">
                ...
                render: (data, style) => {
                    ...
                    switch(layout) {
                        ...
                        case 'professional':
                            return `
                                <div class="relative py-16 px-6 bg-gray-50 overflow-hidden">
                                    ${generateBanner(bannerMode)}
